...
"""
Create animation from the colored haus model
"""
...
# Animation
FRAMES = 300
CAMERA_DISTANCE = 40  # Closer camera for larger house view
CAMERA_HEIGHT = 4     # Lower camera height (~170 units from ground)
...
# Save scene
output_blend = os.path.join(OUTPUT_DIR, "haus_animation_ready.blend")
...
print(f"Scene: {output_blend}")
print("\nTo render all frames:")
print(f"  blender -b {output_blend} -a")
print("\nOr render animation now...")
print("="*60)
...
print("="*60)
print(f"Frames saved in: {OUTPUT_DIR}/frame_####.png")
print("="*60)
